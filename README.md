# Курсовой проект жёлтого пояса по С++

## Введение
Разработать и развить базу данных, работающую с парами (дата, событие), научить её выбирать и удалять события, удовлетворяющие 
заданному условию, а также разделить её код на несколько файлов.
